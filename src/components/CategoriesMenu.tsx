...
export function CategoriesMenu({triggerLabel, items, quickLinks = [], className}: Props) {
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8" ref={rootRef}>
        <div className="relative flex h-11 items-center justify-between gap-3 sm:h-12">
          <button
            ...
            className="inline-flex h-10 items-center gap-2 rounded-2xl border border-slate-300 bg-white px-4 text-sm font-semibold text-slate-800"
            aria-expanded={open}
          >
            {triggerLabel}
            <svg
